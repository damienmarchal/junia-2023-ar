...
void Environement::genereArbre(int pourcentage){
    /*
...
void Environement::initMap(int pourcentageArbre,int nombreRobot) {
...
int *Environement::getSize() {
    return this->size;
}

void Environement::arroser(Robot *robot) {
